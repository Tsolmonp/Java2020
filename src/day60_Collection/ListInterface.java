...
public class ListInterface {
    ...
    public static void main(String[] args) {
        ...
        groups.addAll(Arrays.asList(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(),
                new ArrayList<>(),
                new ArrayList<>(),
                new ArrayList<>(),
                new ArrayList<>(),
        ...
        groups.get(0).addAll(Arrays.asList("Alexey", "Ana", "Andrei", "Busra", "Busra,Y"));
        groups.get(1).addAll(Arrays.asList("Alexey", "Ana", "Andrei", "Busra", "Busra,Y"));
        groups.get(2).addAll(Arrays.asList("Alexey", "Ana", "Andrei", "Busra", "Busra,Y"));
        groups.get(3).addAll(Arrays.asList("Alexey", "Ana", "Andrei", "Busra", "Busra,Y"));
        groups.get(4).addAll(Arrays.asList("Alexey", "Ana", "Andrei", "Busra", "Busra,Y"));
